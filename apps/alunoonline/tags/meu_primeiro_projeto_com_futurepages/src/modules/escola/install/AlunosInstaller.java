...
public class AlunosInstaller extends Installer{
    ...
    public void execute(){
        ...
        Dao.save(new Aluno("02N1047451", "Jọo Fulano Cavalcante Soares"));
        Dao.save(new Aluno("99S5447050", "Ant̫nio Feliciano Gomes"));
        Dao.save(new Aluno("99S5000001", "Sicrano da Silva e Silva"));
        Dao.save(new Aluno("99S8348349", "Maria Antonieta da Costa"));
        Dao.save(new Aluno("93E9394322", "Jos̩ Pompeu Exemplus da Silva"));
    }
}