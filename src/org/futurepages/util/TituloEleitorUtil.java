...
public class TituloEleitorUtil {
	...
	//example: 0295251315-62
	@SuppressWarnings("Duplicates")
	public static String getDigito(String strSequencial) {
		int ind1, ind2, limite, soma, digito;
		String strDVc = "";
		String strUF = strSequencial.substring(9, 11);
	...
	public static void main(String[] args) {
		System.out.println(getDigito("29525131562"));
	}
}