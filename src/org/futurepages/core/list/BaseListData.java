...
import org.futurepages.core.i18n.I18N;
import org.futurepages.core.i18n.I18NMap;
import org.futurepages.core.i18n.LocaleManager;
import org.futurepages.util.StringComparator;
...
public class BaseListData implements ListData {
	...
	public String getValue(String id, Locale loc) {
		...
		ListItem item = (ListItem) m.get(id);
